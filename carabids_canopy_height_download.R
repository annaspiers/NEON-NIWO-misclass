...
path_to_tifs = "DP3.30015.001/2017/FullSite/D13/2017_NIWO_1/L3/DiscreteLidar/CanopyHeightModelGtif/"
...
writeRaster(full, filename = "../neonCHM_1x1.grd")
...
writeRaster(full_25, filename = "../neonCHM_25x25.grd")
