...
>>>>>>> da94ad7b62c164ae542707d49b0a4ebbf765f547
...
<!-- will add details about this method --> 
We were not able to get the code to run smoothly before the end of the semester. If we had more time, this would be the next step in our project. 
...
* Cross-validate the best-fit model for each species ( = get the code to run)
